...
public class LogoStellarBurgersTest {
    ...
    public void logoStellarBurgersTest() throws InterruptedException {
        ...
        profileLK.clickStellarBurgerLogo();
        assertTrue(stellarBurgers.checkPlaceOrder());
    }
    @After
